 ...
 * "Aluno aprovado.". Se a média calculada for inferior a 5.0, imprima a mensagem "Aluno reprovado.". Se a 
 * média calculada for um valor entre 5.0 e 6.9, inclusive estas, o programa deve imprimir a mensagem "Aluno 
 * em exame.".
 * No caso do aluno estar em exame, leia um valor correspondente à nota do exame obtida pelo aluno. 
 * Imprima então a mensagem "Nota do exame: " acompanhada pela nota digitada. Recalcule a média (some a 
 * pontuação do exame com a média anteriormente calculada e divida por 2). e imprima a mensagem "Aluno 
 * aprovado." (caso a média final seja 5.0 ou mais ) ou "Aluno reprovado.", (caso a média tenha ficado 4.9 
 * ou menos). Para estes dois casos (aprovado ou reprovado após ter pego exame) apresente na última linha 
