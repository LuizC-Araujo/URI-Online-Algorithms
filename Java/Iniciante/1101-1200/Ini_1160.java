 ...
 * de crescimento maior para a cidade A. Sua tarefa é construir um programa que apresente o tempo em 
 ...
 *  indicando respectivamente a população de A e B, e dois valores G1 e G2 (0.1 ≤ G1 ≤ 10.0, 0.0 ≤ G2 ≤ 10.0, 
 *  G2 < G1) com um digito após o ponto decimal cada, indicando respectivamente o crescimento populacional 
 *  de A e B (em percentual).
 *  Atenção: A população é sempre um valor inteiro, portanto, um crescimento de 2.5 % sobre uma população 
 *  de 100 pessoas resultará em 102 pessoas, e não 102.5 pessoas, enquanto um crescimento de 2.5% sobre 
 *  uma população de 1000 pessoas resultará em 1025 pessoas. Além disso, não utilize variáveis de precisão 
 *  simples para as taxas de crescimento.
 *  
 *  SAÍDA
 *  Imprima, para cada caso de teste, quantos anos levará para que a cidade A ultrapasse a cidade B em número 
 *  de habitantes. Obs.: se o tempo for mais do que 100 anos o programa deve apresentar a mensagem: Mais de 1 
 *  seculo. Neste caso, acredito que seja melhor interromper o programa imediatamente após passar de 100 anos, 
...
public class Ini_1160 {
	
	public static void main(String[] args) {
		Locale.setDefault(Locale.US);
		Scanner input = new Scanner(System.in);
		
		int T = input.nextInt(), anos = 0;
		long PA, PB;
		double G1, G2;
