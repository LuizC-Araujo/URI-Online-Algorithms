 ...
 * calcule e mostre a soma ou a média considerando somente aqueles elementos que estão na área esquerda da 
...
public class Ini_1189 {
	...
	public static void main(String[] args) {
		...
		for(linha = 0; linha < M.length; linha++) {
			for(coluna = 0; coluna < M[linha].length; coluna++){
				if(linha > coluna && linha < M.length - coluna - 1) {
					soma += M[linha][coluna];
					contNumeros++;
				}
			}
